...
Questo metodo scarica soltanto la release ufficiale `v0.3.0-beta.4`, verifica automaticamente il checksum SHA-256, installa il programma nella cartella personale di Windows e crea il collegamento nel menu Start. Se esiste una precedente installazione gestita dal Toolbox, la aggiorna senza disinstallarla.
...
2. Apri la versione **M.G Windows Toolbox 0.3.0 Beta 4**.
3. Scorri fino alla sezione **Assets**.
4. Scarica `MG_Windows_Toolbox_0.3.0-beta.4_win64.zip`.
